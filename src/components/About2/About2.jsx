...
export default function About2() {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 00 1440 320">
        <path
          fill="#af0745"
          fillOpacity="10"
      ...
      <section className="about2">
        ...
        <div className="main-about2">
          <div className="divabout2">
            <p className="pdoabout"><img className='svgabout2' src={shower} alt="" />Banho</p>
            <p className="pdoabout"><img className='svgabout2' src={secador} alt="" />Tosa</p>
            <p className="pdoabout"><img className='svgabout2' src={guided} alt="" />Adestramento</p>

           
          </div>
          <div className="divabout2">
          <p className="pdoabout"><img className='svgabout2' src={veterinario} alt="" />Veterinário</p>
            <p className="pdoabout"><img className='svgabout2' src={hotel} alt="" />Dog Hotel</p>
            <p className="pdoabout"><img className='svgabout2' src={surgery} alt="" />Cirurgias</p>
         
          </div>
        </div>
      </section>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 60 1440 320">
        <path
          fill="#af0745"
          fillOpacity="10"
